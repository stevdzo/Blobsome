...
Button::Button(const unsigned int p_numberOfTextures) : Sprite(p_numberOfTextures) {
...
void Button::is_clicked(const bool p_value) { m_is_clicked = p_value; }
const bool Button::is_clicked() const { return m_is_clicked; }
